...
export default function Header() {
  ...
  return (
    <header className="font-space bg-background text-foreground z-1 relative max-h-[4.75rem] flex-1 backdrop-blur supports-[backdrop-filter]:bg-[var(--color-background)]">
